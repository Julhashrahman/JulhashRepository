/**
PacksendTheme script to handle the theme PacksendTheme
**/
var PacksendTheme = function () {
    ...
    var handleTheme = function () {
        ...
        if ($('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(Packsend.isRTL() ? 'right' : 'left');
        }
        ...
        var setColor = function (color) {
            var color_ = (Packsend.isRTL() ? color + '-rtl' : color);
